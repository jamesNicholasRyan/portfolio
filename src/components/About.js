    ...
    <div className='section'>
      <div className='columns is-centered is-multiline is-half-mobile'>
        <div className='columns column is-centered is-four-fifths'>
          ...
          <div className='column is-half-tablet is-three-quarters-desktop item'>
            <div className='darkText block is-size-2-desktop is-size-6-tablet has-text-left has-text-weight-semibold bottom'>
              Hi there, welcome to my portfolio!
            </div>
            <div className='darkText block is-size-2-desktop is-size-6-tablet has-text-left has-text-weight-semibold'>
